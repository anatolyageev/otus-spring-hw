...
public class CsvDataLoader implements DataLoader {
    ...
    public CsvDataLoader(@Value("${quiz.file}") String fileName, Locale locale) {
    ...
    private List<String[]> readFileAsStream(String csvFileName, int skipLine) throws Exception {
